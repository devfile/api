...
func (in *Command) DeepCopyInto(out *Command) {
	*out = *in
	...
	in.CommandsUnion.DeepCopyInto(&out.CommandsUnion)
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CommandsUnion) DeepCopyInto(out *CommandsUnion) {
	*out = *in
	if in.Exec != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CommandsUnion.
func (in *CommandsUnion) DeepCopy() *CommandsUnion {
	if in == nil {
		return nil
	}
	out := new(CommandsUnion)
	in.DeepCopyInto(out)
	return out
}
