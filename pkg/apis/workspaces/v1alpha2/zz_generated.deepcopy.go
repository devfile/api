...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in TopLevelLists) DeepCopyInto(out *TopLevelLists) {
	{
		in := &in
		*out = make(TopLevelLists, len(*in))
		for key, val := range *in {
			var outVal []string
			if val == nil {
				(*out)[key] = nil
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TopLevelLists.
func (in TopLevelLists) DeepCopy() TopLevelLists {
	if in == nil {
		return nil
	}
	out := new(TopLevelLists)
	in.DeepCopyInto(out)
	return *out
}
